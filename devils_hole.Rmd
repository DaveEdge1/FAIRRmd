...
Data can be loaded into R in many ways. For example, to load data from an excel file you could use the `openxlsx` package. To follow FAIR principles, however, we have put the data on figshare:
